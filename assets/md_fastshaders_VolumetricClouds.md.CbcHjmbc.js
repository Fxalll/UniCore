import{_ as i,c as a,o as n,ag as l}from"./chunks/framework.Cpwom3JO.js";const p="/UniCore/assets/image.Bb-qHeSg.png",h="/UniCore/assets/image-2.CjNy8fWc.png",k="/UniCore/assets/image-1.DpOlZXoc.png",y=JSON.parse('{"title":"全球体积云","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"md/fastshaders/VolumetricClouds.md","filePath":"md/fastshaders/VolumetricClouds.md","lastUpdated":1766107012000}'),t={name:"md/fastshaders/VolumetricClouds.md"};function e(r,s,F,d,E,c){return n(),a("div",null,[...s[0]||(s[0]=[l('<h1 id="全球体积云" tabindex="-1">全球体积云 <a class="header-anchor" href="#全球体积云" aria-label="Permalink to &quot;全球体积云&quot;">​</a></h1><h3 id="介绍" tabindex="-1">介绍 <a class="header-anchor" href="#介绍" aria-label="Permalink to &quot;介绍&quot;">​</a></h3><p>体积云用于提升场景逼真度，本文提供示例着色器，下文附带使用方法。可自行优化随机函数，使云朵更自然逼真。</p><p><img src="'+p+'" alt="alt text"></p><p><img src="'+h+'" alt="alt text"></p><p><img src="'+k+`" alt="alt text"></p><h3 id="在线演示" tabindex="-1">在线演示 <a class="header-anchor" href="#在线演示" aria-label="Permalink to &quot;在线演示&quot;">​</a></h3><p>点击 <a href="http://192.168.4.66:8091/?id=VolumetricClouds" target="_blank" rel="noreferrer">在线链接</a> 以查看在线演示。</p><h3 id="使用方法" tabindex="-1">使用方法 <a class="header-anchor" href="#使用方法" aria-label="Permalink to &quot;使用方法&quot;">​</a></h3><h4 id="_1、在src文件夹下新增-src-shaders-volumetricclouds-glsl-js" tabindex="-1">1、在src文件夹下新增 <code>src/shaders/VolumetricClouds.glsl.js</code> <a class="header-anchor" href="#_1、在src文件夹下新增-src-shaders-volumetricclouds-glsl-js" aria-label="Permalink to &quot;1、在src文件夹下新增 \`src/shaders/VolumetricClouds.glsl.js\`&quot;">​</a></h4><p>填充着色器代码：</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// src/shaders/VolumetricClouds.glsl.js</span></span>
