...
## Model 类的方法 - shadowChange

### 方法介绍

UniCore 内置 Model 类，提供 shadowChange 方法用于开启或关闭阴影遮挡功能。
...
点击 [在线链接](http://192.168.4.56:8091/?id=shadowChange) 以查看在线演示。
    ...
    */
    init () {
      ...
      uniCore.model.addGltf({
        ...
        uniCore.model.shadowChange(true);
      })
    }
...
你可以通过修改 shadowChange 中的布尔值查看修改这些变量带来的效果。
